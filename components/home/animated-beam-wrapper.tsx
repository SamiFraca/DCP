...
export function AnimatedBeamWrapper({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "relative flex h w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl",
        className
      )}
      ref={containerRef}
    >
